  ...
  Array(14)
    ...
    .forEach((v, i) => {
      ...
      Blocks[uuid()] = {
        ...
        duration: 45,
        items: [
          /* { [uuid()]: { id: number, name: item + number, time: 270 } } */
        ],
        number: number,
        sheltered: sheltered,
      };
  ...
  [uuid()]: {
    items: [
      ...
      },
      {
        [uuid()]: {
          id: "CC219",
          name: "TALLER DE APLICACIONES WEB",
          time: 270,
          type: "asi",
        },
      },
      {
        [uuid()]: {
          id: "CC093",
          name: "COMUNICACIÓN DE DATOS Y REDES",
          time: 270,
          type: "asi",
        },
      },
      ...
      },
      {
        [uuid()]: {
          id: "CC094",
          name: "TEORÍA DE LA COMPUNTACIÓN",
          time: 270,
          type: "asi",
        },
      },
  ...
  ICCI: {
    malla: [
      ...
      [
        ...
        {
          code: "CC214",
          course: "TALLER DE ETICA PROF. Y RESPONS. SC. DEL INFORMAT",
        },
      ],
      [
...
export const Careers = {
  ICCI: {
    name: "Ing. Civil en Computación e Informatica",
    numSemestersWithoutSchedule: 1,
  },
    ...
    items: [
      {
        [uuid()]: {
          id: "DOC-DAP",
          firstName: "DIEGO",
          lastName: "ARACENA PIZARRO",
          email: "DARACENA@ACADEMICOS.UTA.CL",
          type: "doc",
        },
      },
      {
        [uuid()]: {
          id: "DOC-MAB",
          firstName: "MAURICIO",
          lastName: "ARRIAGADA BENÍTEZ",
          email: "MARRIAGADA@ACADEMICOS.UTA.CL",
          type: "doc",
        },
      },
      {
        [uuid()]: {
          ...
          email: "RESPINOSA@ACADEMICOS.UTA.CL",
          type: "doc",
        },
      },
      {
        [uuid()]: {
          id: "DOC-RHA",
          firstName: "RAÚL",
          lastName: "HERRERA ACUÑA",
          email: "RHERRERA@ACADEMICOS.UTA.CL",
          type: "doc",
        },
      },
      {
        [uuid()]: {
          id: "DOC-HOD",
          firstName: "HÉCTOR",
          lastName: "OSSANDÓN DÍAZ",
          email: "HOSSANDO@UTA.CL",
          type: "doc",
        },
      },
      {
        [uuid()]: {
          id: "DOC-IRV",
          firstName: "IBAR",
          lastName: "RAMÍREZ VARAS",
          email: "IRAMIREZ@UTA.CL",
          type: "doc",
        },
      },
      {
        [uuid()]: {
          id: "DOC-RVP",
          firstName: "RICARDO",
          lastName: "VALDIVIA PINTO",
          email: "RVALDIVI@ACADEMICOS.UTA.CL",
          type: "doc",
        },
      },
    ],
